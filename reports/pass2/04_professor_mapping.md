...
Generated: 2026-09-10T19:51:06.333764+00:00

Decision: **PASS**

## Outcome

All 45 faculty-review-ready programs were searched against a current official faculty roster or department research-area listing. Exactly five plausible candidates were evaluated for each program (225 program-candidate evaluations; 210 distinct people after university-level deduplication).

The defensible retained set contains 25 program-match rows representing 25 distinct professors. Each program has one fully verified strong match in 25 programs; the other 20 programs have no match that clears every evidence gate. One-match programs receive 5 depth points and zero-match programs receive 0. No individual professor score exists in the Stage 4 outputs.
...
Recent-work metadata was available for 78 of 225 candidate evaluations. Discovery-only OpenAlex records never establish appointment, supervision, or recruiting.
...
- 25 of 45 programs have only one fully verified strong match and remain single-professor dependencies.
- 20 programs have no candidate that clears every current-appointment, supervision-authority, strong-fit, and recent-work gate; their faculty depth is 0.
- 200 plausible program-candidate evaluations were not retained because exact-route supervision authority and/or candidate-specific recent-work evidence remains incomplete.
